...
namespace Battleship.Forms
{
    public partial class BattleshipForm : Form
    {
        ...
        {
            for (int row = 0; row < PlayerGrid.RowCount; row++)
            {
                for (int col = 0; col < PlayerGrid.ColumnCount; col++)
                {
                    ...
                    this.PlayerGrid.Controls.Add(gameTile, col, row);
                }
            }
        }
        ...
        {
            for (int row = 0; row < EnemyGrid.RowCount; row++)
            {
                for (int col = 0; col < EnemyGrid.ColumnCount; col++)
                {
                    ...
                    EnemyGrid.Controls.Add(gameTile, col, row);
                }
            }
        }
    ...
    public class PlayerShotTiles : GameTiles
    {
        ...
        protected override void OnClick(EventArgs e)
        {
            if (clicked == 0)
            {
                ...
                BattleshipForm.textBox1.Text = $"You targeted: {row},{col} : \n";
                switch (hr)
                {
        ...
        public void enemyHit()
        {
             ...
             switch (enemyShot.State)
             {
                ...
                case SquareState.Hit:
                    BattleshipForm.textBox1.Text +=" Your ship was hit";
